...
if __name__ == '__main__':
    ...
    delta_axis = [0.1, 0.7, 0.6, 0.6] # all view
    ...
    while not rospy.is_shutdown():
        if my_plotter.show_nom:
            ...
            my_plotter.ax.plot(my_plotter.x_nom, my_plotter.z_nom, 'om')
            plt.draw()
            plt.pause(0.001)
        ...
        if my_plotter.show_cur:
            ...
            my_plotter.ax.plot(my_plotter.x_cur, my_plotter.z_cur, 'og')
            plt.draw()
            plt.pause(0.001)
        ...
        if my_plotter.show_hum:
            ...
            my_plotter.ax.plot(my_plotter.x_hum, my_plotter.z_hum, 'ob')
            plt.draw()
            plt.pause(0.001)
        ...
        axis = [my_plotter.x_0 - delta_axis[0], my_plotter.x_0 + delta_axis[1], my_plotter.z_0 - delta_axis[2], my_plotter.z_0 + delta_axis[3]]
        plt.axis(axis)
        plt.grid()
